...
import com.example.mobileappsproject.RouteFragment.OnListFragmentInteractionListener;
import com.example.mobileappsproject.Route.RouteContent;
...
public class MyRouteRecyclerViewAdapter extends RecyclerView.Adapter<MyRouteRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRouteRecyclerViewAdapter(List<RouteContent.Route> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).route_name);
